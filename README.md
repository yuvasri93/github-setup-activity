...
GitHub:
GitHub is an online platform that helps developers store and manage code.

Repository:
A repository is a storage space where your project files are kept.

Commit:
A commit saves changes made to files.
...
This is my first step towards using GitHub for academic and professional growth.
